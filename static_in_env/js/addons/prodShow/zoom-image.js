     ...
     */
     $.fn.zoomImage =  function(paras) {
        ...
        var defaultParas = {
            ...
            layerH: 100, // Masker hoogte
            layerOpacity: 0.2, // 遮罩透明度
            layerBgc: '#000', // 遮罩背景颜色
            showPanelW: 275, // Breedte weergavegebied
            showPanelH: 120, // Hoogte weergavegebied
        ...
        $(this).each(function() {
            ...
            */
            ...
            // Hoogte vergroting (5x)
            var hTimes = paras.showPanelH / paras.layerH;

            // Vergroot de afbeelding
            var img = $('<img>').attr('src', $('#zi-show-img').attr("src")).css({
                position: 'absolute',
                left: '0',
                top: '0',
            ...
            /// Left en top zijn de positionering van dat ding
            /*
